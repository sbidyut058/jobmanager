...
class InvalidTypeError extends JobError {
    constructor(property: string, expectedType: string, receivedType: string) {
...
class InvalidInstanceError extends JobError {
    constructor(property: string, expectedNames: string[]) {
...
class InvalidSchemaDefinitionError extends JobError {
    constructor(propertyOrMessage: string, detail = "") {
